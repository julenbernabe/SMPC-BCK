...
tokenAddress = '0x8D5a5965338AaE0FbC02B16D1720c29f92CD7c94'
...
def getToken(w3):
    ...
    with open('config/Token.json') as json_file:
        ...
        abi = data['abi']
        # The previous instructions will be useful for us in order to load the contract and return it in the following commands
        Contract = w3.eth.contract(abi=abi, address=w3.toChecksumAddress(tokenAddress))       # Note that we have called config to
                                                                                                        # obtain the contract address
    return Contract

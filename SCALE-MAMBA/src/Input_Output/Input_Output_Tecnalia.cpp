...
#include "Input_Output_Tecnalia.h"
#include "Input_Output_File.h"
#include "Exceptions/Exceptions.h"

long Input_Output_Tecnalia::open_channel(unsigned int channel)
{
  cout << "Opening channel " << channel << endl;
  return 0;
}

void Input_Output_Tecnalia::close_channel(unsigned int channel)
{
  cout << "Closing channel " << channel << endl;
}

gfp Input_Output_Tecnalia::private_input_gfp(unsigned int channel)
{
  string str;
